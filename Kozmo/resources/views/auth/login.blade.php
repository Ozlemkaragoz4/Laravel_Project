...
<head>
    ...
    <!-- Font Awesome -->
    <link href="{{asset('KZM/vendors/font-awesome/css/font-awesome.min.cs')}}s" rel="stylesheet">
    <!-- NProgress -->
    <link href="{{asset('KZM/vendors/nprogress/nprogress.css')}}" rel="stylesheet">
    <!-- Animate.css -->
    <link href="{{asset('KZM/vendors/animate.css/animate.min.css')}}" rel="stylesheet">
    <!-- Custom Theme Style -->
